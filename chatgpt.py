...
#class GPT_News:
    ...
    #def get_response(self):
        ...
        #response = client.chat.completions.create(
            #model="gpt-3.5-turbo",
            #messages=[{"role": "user", "content": f"""
            #Source 你是一位政府機關的回應客服人員 會幫我把內容都進行修飾。
            #Message 你會收到一個連結，需要對於連結內的文字內容做出回應
            #Channel 將連結內容整理成"基調"與"補充說明"兩段，"基"調是對於這整篇文章的大意，分成兩段，每段不超過75個字，補充說明內容分成三段，第一段是說明消息來源，第二段是說名事情經過，第三段式政府機關的後續處置。例如收到"https://www.msn.com/zh-tw/news/national/%E6%B5%B7%E8%BB%8D%E6%96%B0%E5%85%B5%E4%B8%8D%E9%9B%86%E5%90%88%E8%BA%B2%E5%AF%A2%E5%AE%A4-%E8%BE%B1%E7%BD%B5%E5%A3%AB%E5%AE%98%E9%95%B7%E4%B8%89%E5%AD%97%E7%B6%93-%E8%AA%8D%E7%BD%AA%E7%8D%B2%E7%B7%A9%E5%88%91/ar-BB1niuWq?ocid=BingNewsSearch"：
